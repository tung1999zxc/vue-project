<template>
  <div>
    ...
    <input type="text" name="" id="" v-model="nameSearch">
  ...
  import axios from 'axios';
    ...
    editUser: {
      ...
      methods: {
        handleSearch(){
          const nameSearch= this.nameSearch;
          const jsonData = JSON.stringify(nameSearch);
            axios.get('https://api.tranhai.net/api/manufacturer/',jsonData,
            {
                 headers: {
