        ...
        <table class="table table-striped table-dark">
          ...
          <div class="col-3 ">
            ...
            <form accept-charset="UTF-8" @submit.prevent="editUser.id ? updateBook() : addNewBook()">
              ...
              <input class="form-control " type="text" id="title" v-model="editUser.title" v-if="editUser.id" required>
              <input class="form-control " type="text" id="title" v-model="newBook.title" v-else required>
              <br>
              <label for="author">Slug</label>
              <input class="form-control " type="text" id="author" v-model="editUser.author" v-if="editUser.id" required>
              ...
              <input class="form-control" type="text" id="author" v-model="editUser.Description" v-if="editUser.id" required>
              <input class="form-control" type="text" id="author" v-model="newBook.Description"   v-else required>
              <br>
              <label for="author">Website</label>
              <input class="form-control" type="text" id="author" v-model="editUser.Website" v-if="editUser.id" required>
              <input class="form-control" type="text" id="author" v-model="newBook.Website" v-else  required>
              <br>
