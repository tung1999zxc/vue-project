    ...
    <div class="col-3">
      <table class="table table-striped    ">
        ...
        <tr v-for="todo in todos" :key="todo.id">
          ...
          <td> <button @click="handleEdit(todo.id)">Edit</button></td>
          <td> <button @click="handleDelete(todo.id)">Delete</button></td>
          <td> <button @click="handleCo(todo.id)">Hoàn thành</button></td>
        </tr>
