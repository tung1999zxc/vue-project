<template>
    <div class="menu bg-success">
      <ul class="">
        ...
        <li v-if="checkAuthentication" class="ml-auto btn border-primary bg-primary" style="margin-left : 700px;">
         <router-link to="/Login">{{checkAuthentication? 'Đăng nhập' : 'Đăng xuất'}}</router-link>
         </li>
        <!-- <li class="ml-auto btn border-primary bg-primary" style="margin-left : 700px;">
