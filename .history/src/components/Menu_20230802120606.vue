    ...
    <div>
      <div class="justify-content-between d-flex px-5 py-3 " style="background: #aab3c4; ">
        ...
        <div class="d-flex"><div v-if="!isAuthenticated" class="btn btn-primary " >
         ...
         <div v-else class="btn btn-danger ml-2" >
          <div @click="handleLogout">Đăng xuất</div></div>
         <div class="btn btn-primary "  v-show="!isAuthenticated"><router-link class=" h4 px-3 text-dark text-decoration-none" to="/Regis">Đăng Kí</router-link></div></div>
