  ...
  <section class="intro-2">
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="intro-2-img1 col-md-6 order-md-2" style=" background-image: url(../assets/bg-showcase-1.jpg);"></div>
      ...
      <div class="row">
        ...
        <div class="intro-2-img2 col-md-6 " style=" background-image: url(../assets/bg-showcase-2.jpg);"></div>
    ...
    <div class="row mb-5">
      ...
      <div class="intro-2-img3 col-md-6 order-md-2" style="background-image: url(../assets/bg-showcase-3.jpg);"></div>
      <div class=" col-md-6 order-md-1  my-auto px-5">
