<template>
  <header class="header">
    <div class="container-fluid p-0">
      <div class=" row justify-content-center " style="background:url(../assets/bg-masthead.jpg) center; background-size: cover; min-height: 20rem;">
  ...
  <section class="intro-2">
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="intro-2-img col-md-6 order-md-2" style=" background-image: url(../assets/bg-showcase-1.jpg);background-size: cover;"></div>
