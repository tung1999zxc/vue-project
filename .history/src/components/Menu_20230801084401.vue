<template>
    <div class="menu bg-success">
      <ul class="">
        ...
        <li v-if="!$store.state.isAuthenticated" class="ml-auto btn border-primary bg-primary" style="margin-left : 700px;">
         <router-link to="/Login">Đăng nhập</router-link>
         </li>
        <li v-show="$store.state.isAuthenticated" class="ml-auto btn border-primary bg-primary" style="margin-left : 700px;">
