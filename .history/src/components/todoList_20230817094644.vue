<template>
  <div v-if="!store.isAuthenticated"><p class="text-center mt-5 h5">Vui lòng đăng nhập hoặc đăng ký để truy cập vào trang chủ.</p></div>
 
  
      
  </div>  <div v-else><div class="todo-list">
    <h2>Todo List</h2>
