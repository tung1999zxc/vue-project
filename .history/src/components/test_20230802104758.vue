<template>
  <header class="header">
    <div class="container-fluid p-0">
      <div class=" row justify-content-center add-img " style="background:url(../assets/bg-masthead.jpg) center; background-size: cover; min-height: 20rem;">
  ...
  <section class="intro-2">
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="intro-2-img col-md-6 order-md-2" style=" background-image: url(../assets/bg-showcase-1.jpg);"></div>
      ...
      <div class="row">
        ...
        <div class="intro-2-img col-md-6 " style=" background-image: url(../assets/bg-showcase-2.jpg);"></div>
    ...
    <div class="row mb-5">
      ...
      <div class="intro-2-img col-md-6 order-md-2" style=" background-image: url(../assets/bg-showcase-3.jpg);"></div>
      <div class=" col-md-6 order-md-1  my-auto px-5">
  ...
  <section class="ready img-fluid" style="background: url('../assets/bg-masthead.jpg')   ; min-height: 300px; background-size: cover; ">
    <div class="container-fluid">
