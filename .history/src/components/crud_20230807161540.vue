        ...
        <table class="table">
          ...
          <div class="col-3 ">
            ...
            <form accept-charset="UTF-8" >
              ...
              <button class="btn-block bg-success" type="" @click="addNewUser"> Thêm User</button>
              <button class="btn-block bg-success" type="" @click="updateUser">Lưu</button>
  ...
  import axios from 'axios';
    ...
    editUser: {
      ...
      methods: {
        ...
        getUsers() {
      axios.post('https://api.tranhai.net/api/manufacturer/_search', {
  "Page": 1,
  "PageSize": 10 }
// {
//                  headers: {
...
//          }}
    ...
    _editUser(User) {
      const idEdit = User.Id;
      this.newUser.Name = User.Name;
      this.newUser.Slug = User.Slug;
      this.newUser.Description = User.Description;
      this.newUser.Website = User.Website;
    },
    updateUser() {
      axios.put(`https://api.tranhai.net/api/manufacturer/:id=${idEdit}`, this.newUser)
        .then(response => {
          console.log(response.data)
          this.getUsers();
          this.editUser = {
