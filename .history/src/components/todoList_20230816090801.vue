<!-- <template>
  <div v-if="!isAuthenticated"><p class="text-center h3 mt-5 text-danger ">Bạn phải đăng nhập để sử dụng</p></div>
...
const isAuthenticated: boolean = computed(()=> store.getters['auth/isAuthenticated']);
