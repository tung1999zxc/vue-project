<template>
    <div class="menu bg-primary row">
      <div class="col">
        ...
        <div v-if="!isAuthenticated" class="ml-auto btn border-primary bg-primary" style="margin-left : 700px;">
         <router-link to="/Login">Đăng nhập</router-link>
         </div>
   
        <div v-else class="ml-auto btn border-primary bg-primary" style="margin-left : 700px;">
         <a @click="handleLogout">Đăng xuất</a>
         </div>
        
        <li v-show="!isAuthenticated"><router-link to="/Regis">Đăng Kí</router-link></li>
      </div>
    </div>
  </template>
