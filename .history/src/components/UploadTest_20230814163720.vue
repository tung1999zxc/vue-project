...
<template>
  <div>
   ...
   <div class="col-4">
    <input v-model="addNewtodo.value.Name" @keyup.enter="addName" placeholder="Enter a name" />
    <input v-model="addNewtodo.value.Time" @keyup.enter="addName" placeholder="Enter a name" />
