...
//          }}
    ...
    updateUser() {
      ...
      axios.put(`https://api.tranhai.net?id=${this.editUser.id}`, this.editUser)
        .then(response => {
          console.log(response.data); // Kết quả từ API
          this.getUsers();
          this.editUser = {
    ...
    deleteUser(UserId) {
      axios.delete('https://api.tranhai.net/api/manufacturer?ids=8464cdf0-7824-4137-a6a6-e7b9b4294e4f')
        .then(response => {
