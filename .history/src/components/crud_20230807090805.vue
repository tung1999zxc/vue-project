    ...
    <div class="row bg-light ">
        ...
        <table class="table table-striped table-dark">
          ...
          <div class="col-3 ">
            ...
            <form accept-charset="UTF-8" @submit.prevent="editBookData.id ? updateBook() : addNewBook()">
              ...
              <input class="form-control" type="text" id="author" v-model="editUser.Description" v-if="editBookData.id" required>
              <input class="form-control" type="text" id="author" v-model="newBook.Description"   v-else required>
              <br>
              <label for="author">Website</label>
              <input class="form-control" type="text" id="author" v-model="editUser.Website" v-if="editBookData.id" required>
