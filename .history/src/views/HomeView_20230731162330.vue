<template>
  <div>
    ...
    <div v-else>Vui lòng đăng nhập hoặc đăng ký để truy cập vào trang chủ.<br><router-link to="/login" >Đăng nhập</router-link></div>
    <router-link  v-show="!isAuthenticated" to="/Login">Đăng nhập</router-link>
  </div>
</template>
